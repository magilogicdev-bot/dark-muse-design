// Download white-box-room image from Figma
...
if (!token) {
  ...
  console.error('Usage: node scripts/download-white-box-room.cjs [FIGMA_TOKEN]');
  console.error('Or set: FIGMA_TOKEN=your-token node scripts/download-white-box-room.cjs');
...
async function main() {
  console.log('📥 Downloading white-box-room from Figma...\n');
  ...
  try {
    ...
    console.error('\n💡 Manual download:');
    console.error(`   https://www.figma.com/design/${fileKey}/ALFA-12.15?node-id=1090-8387&m=dev`);
    process.exit(1);
  }
}
