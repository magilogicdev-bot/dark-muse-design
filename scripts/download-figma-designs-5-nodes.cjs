// Download 5 specific designs from Figma
...
const fileNames = ['design-5023-5', 'design-5023-4', 'design-1090-8364', 'design-1090-8354', 'design-1090-8355'];
  ...
  try {
    ...
    if (response.images) {
      for (let i = 0; i < nodeIds.length; i++) {
        ...
        if (imageUrl) {
          const filePath = path.join(outputDir, `${fileNames[i]}.png`);
          console.log(`Downloading ${fileNames[i]}...`);
          await downloadFile(imageUrl, filePath);
          console.log(`✓ Saved: ${fileNames[i]}.png`);
        } else {
