  ...
  <section class="py-8 md:py-12 lg:py-16 xl:py-20 bg-primary text-white">
    <div class="container mx-auto max-w-[1920px] px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-10 mb-8 md:mb-12 lg:mb-16">
        ...
        <div class="flex items-center">
          <p class="text-base md:text-lg lg:text-xl text-white/80 leading-relaxed">
            Отделка White Box — оптимальный формат для тех, кто ценит время и хочет реализовать собственный дизайн без сложных черновых работ. Все ключевые инженерные и подготовительные этапы уже выполнены: ровные стены, готовые к покраске или декоративным покрытиям, подготовленные полы, проложенные коммуникации и установленные инженерные системы. Пространство готово к финишной отделке, начиная с чистой качественной базы.
          </p>
        </div>
      </div>
