<template>
  <section class="bg-[#1a1d28] py-16 md:py-20 lg:py-24 relative overflow-hidden">
    <div class="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <!-- Left: Image -->
        <div class="relative">
          <div class="aspect-[4/3] rounded-lg md:rounded-xl lg:rounded-2xl overflow-hidden">
            <img
              src="/images/mortgage-promo.webp"
              alt="Оформи ипотеку с Pobedonoscev GROUP"
...
<script setup>
// Mortgage Promo Section Component
</script>
